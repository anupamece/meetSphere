...
const Navbar = ({ currentRole }) => {
  ...
  useEffect(() => {
    const handleClickOut = (e) => {
      if (profileOpenRef.current && !profileOpenRef.current.contains(e.target)) {
            ...
            <div className="relative" ref={profileOpenRef}>
              ...
              >
                {!isLoggedIn ? (
                  ...
                  <div className="relative flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9">
                    <div className="absolute -inset-0.5 rounded-full blur-[3px] opacity-75 group-hover:opacity-100 transition-premium bg-primary" />
                    <img 
              ...
              {isLoggedIn && profileOpen && (
                <div className="absolute right-0 mt-3 w-52 rounded-2xl bg-white border border-brand-muted shadow-xl py-2 z-50 animate-fade-in font-premium text-sm text-slate-700">
                  ...
                  <div className="py-1" onClick={() => setProfileOpen(false)}>
                    <Link to="/profile" className="block px-4 py-2 hover:bg-brand-bg hover:text-primary transition-premium">
                      My Profile
                    </Link>
                  ...
                  <div className="border-t border-brand-muted py-1" onClick={() => setProfileOpen(false)}>
                    <button  
                      onClick={() => {
                      ...
                      className="block w-full text-left px-4 py-2 text-rose-500 hover:bg-rose-50 hover:font-bold transition-premium cursor-pointer"
                    >
                      Log Out
                    </button>
                  </div>
