    ...
    <section className="py-20 bg-[#EEEEEE]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="font-display text-4xl font-bold tracking-tight text-[#3B1E54]">How meetSphere Works</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Attendee Column */}
          <div className="bg-white p-8 sm:p-10 rounded-3xl border border-[#D4BEE4]/60 shadow-sm space-y-8">
            <div className="border-b border-[#D4BEE4]/50 pb-4">
              <h3 className="font-display text-2xl font-bold text-[#3B1E54] flex items-center">
            ...
            <div className="space-y-6">
              {attendeeSteps.map((step, idx) => (
                <div key={idx} className="flex gap-4 items-start">
                  <span className="font-display text-xl font-bold text-[#9B7EBD] bg-[#D4BEE4]/35 px-3 py-1.5 rounded-xl border border-[#D4BEE4]/40">
                    {step.num}
                  </span>
                  <div>
                    <h4 className="font-premium font-bold text-lg text-[#3B1E54]">{step.title}</h4>
                    <p className="font-premium text-sm text-[#3B1E54]/70 mt-1 leading-relaxed">{step.text}</p>
                  </div>
                </div>
              ))}
            </div>
